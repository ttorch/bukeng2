...
// onMounted(async () => {
//     // const authStore = useAuthStore();
//     // await authStore.getUser('App Vue');

//     console.log("USER", authStore.user) // <div></div>
// });
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" @submit.prevent="authStore.handleLogin(form)">
        <div>
          ...
          <div class="mt-2">
            <input id="email" name="email" type="email" v-model="form.email" autocomplete="email" class="block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
        ...
        <div>
          <div class="flex items-center justify-between">
            <!-- <button @click.prevent="showHidePwd">Show/hide</button> -->
          ...
          <div class="mt-2">
            <input id="password" name="password" type="password" v-model="form.password" autocomplete="current-password" class="block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
        ...
        <div>
          <button type="submit" id="submit" class="flex w-full justify-center rounded-md bg-[#1A7D7A] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#0F9C98] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
        </div>
      </form>
...
export default {
  beforeRouteEnter(to){
    ...
    // const authStore = useAuthStore();
    // console.log("BEFORE ENTER", authStore.user);
